                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-11">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" onchange="changeUser(${user.getId()}, this)" id="cb-${user.getId()}" checked>
                                                    </c:if>
                                                    <c:if test="${not user.getApproved()}">
                                                    <input type="checkbox" class="custom-control-input" onchange="changeUser(${user.getId()}, this)" id="cb-${user.getId()}">
                                                    </c:if>
                                                    <label class="custom-control-label" for="cb-${user.getId()}">[ ${user.getRole()} ] ${user.getUsername()}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
